    ...
    <div className='md:w-2/3 md:h-screen md:text-black md:bg-[#859cf176] md:flex md:justify-center md:items-center bg-[#859cf176] h-[calc(100vh-7rem)] flex justify-center items-center'>
      <div>
        ...
        <div className='flex gap-12 mx-5 font-body justify-center'>
          ...
          <Card img='https://cdn.pixabay.com/photo/2012/04/24/21/29/laptop-40935_960_720.png' user='Student' asa='student/signupstds' />
         
          <Card img='https://westfaironline.com/wp-content/uploads/2023/10/virtual-7071998_1920.png' user='Teacher' asa='teacher/signupteacher' />
